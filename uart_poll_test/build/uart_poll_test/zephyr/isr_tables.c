...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0xc3e9, (ISR)0x103ef}, /* 42 */
	...
	{(const void *)0xc1a9, (ISR)0x103ef}, /* 49 */
